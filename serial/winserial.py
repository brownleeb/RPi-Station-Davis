...
from win9x_serial.mstimer import MsTimer
from win9x_serial.crilib import *
from win9x_serial.sio import *


[RSP_NONE, RSP_TERMINATED, RSP_FIXEDLEN, RSP_BEST_EFFORT] = range(0, 4)
PORT_CLOSED = -1

TimeoutError = SioError
SerialError = SioError
...
"""
    ...
    def open(self, cfg):
        ...
        self._chkSioExec(SioDTR, (port, 'S'))
        self._chkSioExec(SioRTS, (port, 'S'))
    ...
    def readTerminated(self, term=None):
    ...
    def cmd(self, str=''):
        ...
        if rspType == RSP_NONE:
            ...
            fixLen = len(self.cfg['rspFixedLen'])
            if fixLen <= 0:
                raise SioError, \
